...
func TestScalingEndpoint_List_MultiNamespace(t *testing.T) {
	...
	require.NoError(t, state.UpsertJob(902, job1b))
	...
	require.NoError(t, state.UpsertJob(903, job2))
